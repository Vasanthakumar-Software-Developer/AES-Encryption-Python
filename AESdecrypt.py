...
fileout=open("KEY.txt","r")
PassPhrase2=fileout.read()
fileout.close()

while(len(PassPhrase2)%16!=0):
    PassPhrase2=PassPhrase2+"\00"
i=int(len(PassPhrase2)/16)
...
while(i>=1):
    ...
    Filout=io.open(sys.argv[1], 'w', encoding='utf-8')
